...
export default function RacerCaseStudyPage() {
  const reduceMotion = useReducedMotion();
          ...
          <div className="grid items-start gap-8 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5">
              <div className="mb-3 flex flex-wrap items-center gap-2">
                ...
                <Chip tone="green">Realistic Racing Simulator</Chip>
              </div>
                ...
                <div className="relative p-4 sm:p-6">
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex flex-wrap items-center gap-2">
                      <Chip tone="green">Trailer Stage</Chip>
                  ...
                  <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-[0_18px_70px_rgba(0,0,0,0.45)] backdrop-blur transition hover:-translate-y-0.5 hover:border-white/14">
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        <Chip tone="violet">Cinematic</Chip>
            ...
            <div className="relative grid items-center gap-8 lg:grid-cols-12">
              <div className="lg:col-span-8">
                <div className="mb-3 flex flex-wrap items-center gap-2">
                  ...
                  <Chip tone="green">Games • Racing • Multiplayer</Chip>
                </div>
