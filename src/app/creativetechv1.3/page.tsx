...
export default function CreativeTechServices_SimplifiedEditorial() {
              ...
              <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-white/5 p-6">
                ...
                <div className="relative">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Pill tone="cyan">live preview</Pill>
                  </div>
                  ...
                  <div className="mt-5 flex flex-wrap gap-2">
                    <Tag tone="cyan">clear story</Tag>
                    <Tag tone="neutral">simple UX</Tag>
                    <Tag tone="neutral">real delivery</Tag>
                  ...
                  <div key={s.num} className="relative pl-10">
                    ...
                    <div className="rounded-[22px] border border-white/10 bg-[#06041A] p-5">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <Tag tone="cyan">{s.title.toLowerCase()}</Tag>
                      </div>
