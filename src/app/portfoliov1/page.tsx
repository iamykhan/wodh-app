...
const ACCENT_XR = "#9EF315"; // neon green
const ACCENT_GAMES = "#5B2DDC"; // violet
const BASE_BG = "#070814"; // deep indigo-black
          ...
          <div className="relative flex flex-col gap-8">
            <div className="flex flex-col gap-3">
              <div className="flex flex-wrap items-center gap-2">
                <Chip>Portfolio</Chip>
                <Chip tone="muted">Curated Museum</Chip>
                <Chip tone="muted">Selected Work</Chip>
              </div>
      ...
      <section id="portfolio-grid" className="relative mx-auto w-full max-w-6xl px-4 pt-10 sm:px-6 sm:pt-12">
        <div className="mb-5 flex items-end justify-between gap-4">
          ...
          <div className="hidden items-center gap-2 sm:flex">
            <Chip tone="muted">{curated.length} items</Chip>
      ...
      <div className="grid grid-cols-1 gap-0 lg:grid-cols-2">
        ...
        <div className="relative min-h-[260px] overflow-hidden lg:min-h-[420px]">
          ...
          <div className="absolute left-5 top-5 flex items-center gap-2">
            ...
            {item.year ? <Chip tone="muted">{item.year}</Chip> : null}
          </div>
            ...
            <div className="relative p-6 sm:p-7">
              ...
              <div className="relative flex items-start justify-between gap-4">
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <Chip>Filters</Chip>
                    <Chip tone="muted">Curated control</Chip>
                  </div>
