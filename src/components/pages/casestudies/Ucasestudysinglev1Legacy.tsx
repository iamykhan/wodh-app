...
export default function Ucasestudysinglev1Legacy() {
  const reduceMotion = useReducedMotion();
            ...
            <div className="lg:col-span-7">
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <Chip>Glanceability</Chip>
                    <Chip>Explicit states</Chip>
                    <Chip>UX at speed</Chip>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative grid items-center gap-8 lg:grid-cols-12">
              <div className="lg:col-span-8">
                <div className="mb-3 flex flex-wrap items-center gap-2">
                  ...
                  <Chip>Games • Multiplayer • Racing</Chip>
                </div>
