...
export default function CreativeTechV1_1Legacy() {
  ...
  return (
    <main className="relative min-h-screen bg-[#07051A] text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5">
            <div className="flex flex-wrap items-center gap-2">
              <Chip>Creative Tech</Chip>
              <Chip>Neon Lab Console</Chip>
              <Chip>Systems-first</Chip>
            </div>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              <Chip>Deployment-ready</Chip>
              <Chip>Device matrix</Chip>
              <Chip>Offline-first (when needed)</Chip>
            </div>
              ...
              <div className="relative">
                ...
                <div className="mt-4 rounded-2xl border border-white/10 bg-[#06041A] p-4">
                  ...
                  <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <SignalPill label="Perf budget" value="defined" />
                    <SignalPill label="Fallback UX" value="included" />
                    <SignalPill label="Telemetry" value="ready" />
                  </div>
          ...
          <div className="md:col-span-4">
            <div className="rounded-2xl border border-white/10 bg-[#06041A] p-5 overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <Chip>scope clarity</Chip>
                  <Chip>risk reduction</Chip>
                  <Chip>ops readiness</Chip>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 rounded-2xl border border-white/10 bg-[#06041A] p-5 overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                <Chip>prototype-first</Chip>
                <Chip>production discipline</Chip>
                <Chip>operate-ready</Chip>
              </div>
            </div>
          </div>
        </div>
      ...
      <SectionShell
        ...
        eyebrow={
          <div className="flex flex-wrap items-center gap-2">
            <Chip>Tech plays</Chip>
            <Chip>Modules / packages</Chip>
          </div>
        }
        title={
          <>
...
function SignalPill({ label, value, tone = "neutral" }: { label: string; value: string; tone?: "cyan" | "neutral" | "green" }) {
  const cls =
    tone === "cyan"
        ...
        >
          <div className="lg:col-span-7 rounded-2xl border border-white/10 bg-[#06041A] p-5">
            <div className="flex items-start justify-between gap-3">
              ...
              <SpecChip>{data.timeline}</SpecChip>
            </div>
