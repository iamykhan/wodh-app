...
/* =======================================================================================
   ...
   - Delivery: add Tag and use it for Inputs
...
export default function CreativeTechV1_4Legacy() {
              ...
              <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-white/5 p-6">
                ...
                <div className="relative">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    <Tag>device-aware</Tag>
                    <Tag>offline-ready</Tag>
                    <Tag>measurable</Tag>
                  </div>
                </div>
              </div>
