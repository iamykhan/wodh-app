        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Chip>Modular Product Catalog</Chip>
              <Chip>Deployable modules</Chip>
            </div>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              ...
              <Chip>Telemetry-ready</Chip>
              <Chip>Offline-capable</Chip>
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative p-5">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <TagPill label={product.complexity} />
          {product.telemetry ? <TagPill label="Telemetry" /> : <TagPill label="Telemetry (optional)" />}
          {product.offlineReady ? <TagPill label="Offline-ready" /> : <TagPill label="Online-first" />}
        </div>
        ...
        <div className="h-full overflow-y-auto">
          ...
          <div className="p-5 space-y-4">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <TagPill label={product.typicalTimeline} />
                <TagPill label={product.complexity} />
                {product.telemetry ? <TagPill label="Telemetry" /> : <TagPill label="Telemetry optional" />}
                {product.offlineReady ? <TagPill label="Offline-ready" /> : <TagPill label="Online-first" />}
              </div>
      ...
      <div className="lg:col-span-4 rounded-2xl border border-white/10 bg-[#06041A] p-5 overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            ...
            <Chip>buyer-ready</Chip>
            <Chip>deploy-safe</Chip>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <Chip>deploy plan</Chip>
              <Chip>operator runbook</Chip>
              <Chip>telemetry loop</Chip>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="rounded-2xl border border-white/10 bg-white/5 p-5 sm:p-6">
      ...
      <div className="mt-5 grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-5 rounded-2xl border border-white/10 bg-[#06041A] p-5">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Chip>clean deliverables</Chip>
            <Chip>safe deploy</Chip>
