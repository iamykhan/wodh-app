...
export default function PortfolioV1_1Legacy() {
    ...
    >
      ...
      <div className="pl-6">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {item.featured ? <Chip>Featured</Chip> : null}
          <Chip>{item.year}</Chip>
          {item.caseStudy ? <Chip>Case study</Chip> : <Chip>Snapshot</Chip>}
        </div>
      ...
      >
        ...
        <div className="relative h-56 overflow-hidden sm:h-64">
          ...
          <div className="absolute left-4 top-4 flex items-center gap-2">
            <Chip>{item.studio}</Chip>
            <Chip>{item.year}</Chip>
            {item.caseStudy ? <Chip>Case</Chip> : <Chip>Snap</Chip>}
          </div>
