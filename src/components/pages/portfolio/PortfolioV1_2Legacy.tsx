...
export default function PortfolioV1_2Legacy() {
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] p-6 shadow-[0_30px_120px_rgba(0,0,0,0.55)] sm:p-10">
          ...
          <div className="relative flex flex-col gap-7">
            <div className="flex flex-wrap items-center gap-2">
              <Chip>Portfolio</Chip>
              <Chip>Variant E — Signal Matrix</Chip>
              <Chip>Modern + understandable</Chip>
            </div>
                ...
                <div className="relative p-5 sm:p-7">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <div className="flex flex-wrap items-center gap-2">
                        <Chip>Cell</Chip>
                        <Chip>{openCell.row}</Chip>
                        <Chip>{openCell.col}</Chip>
                      </div>
    ...
    >
      <div className="relative h-40 overflow-hidden">
        ...
        <div className="absolute left-4 top-4 flex items-center gap-2">
          <Chip>{p.studio}</Chip>
          <Chip>{p.year}</Chip>
          {p.caseStudy ? <Chip>Case</Chip> : <Chip>Snap</Chip>}
          {p.featured ? <Chip>Featured</Chip> : null}
        </div>
