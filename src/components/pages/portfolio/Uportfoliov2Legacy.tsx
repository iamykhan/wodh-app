...
export default function Uportfoliov2Legacy() {
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] p-6 shadow-[0_30px_120px_rgba(0,0,0,0.55)] sm:p-10">
          ...
          <div className="relative flex flex-col gap-6">
            <div className="flex flex-wrap items-center gap-2">
              <Chip>Portfolio</Chip>
              <Chip variant="default">Variant B — Case Library</Chip>
              <Chip variant="default">Search + Filters</Chip>
            </div>
      ...
      <section id="portfolio-results" className="relative mx-auto w-full max-w-6xl px-4 pt-6 sm:px-6 sm:pt-8">
        <div className="mb-4 flex items-end justify-between gap-4">
          ...
          <div className="hidden items-center gap-2 sm:flex">
            <Chip variant="default">{studio}</Chip>
            <Chip variant="default">{sort}</Chip>
            <Chip variant="default">{view}</Chip>
          </div>
        </div>
...
function SelectPill({
  ...
  return (
    <div className="relative">
      ...
      >
        {options.map((o) => (
          <option key={o} value={o} className="bg-[colors.background.primary] text-white">
            {label}: {o}
          </option>
        ))}
      </select>
  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            className="absolute left-0 z-50 mt-2 w-[320px] overflow-hidden rounded-3xl border border-white/10 bg-[colors.background.primary]/92 shadow-[0_40px_120px_rgba(0,0,0,0.60)] backdrop-blur-xl"
